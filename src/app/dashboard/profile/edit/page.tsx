  ...
  return (
    <div className="">
      ...
      <form onSubmit={onSubmit} className="max-w-xl mx-auto space-y-7">
        ...
        <div>
          <label className="block text-[16px] tracking-wide font-semibold mb-2 text-black">Name</label>
          <input value={name} onChange={e=>setName(e.target.value)} className="w-full rounded-full bg-white border border-gray-200 placeholder:text-black px-6 py-3.5 text-base focus:outline-none" />
        </div>
        <div>
          <label className="block text-[16px] tracking-wide font-semibold mb-2 text-black">Email</label>
          <input value={email} onChange={e=>setEmail(e.target.value)} className="w-full rounded-full bg-white border border-gray-200 placeholder:text-black px-6 py-3.5 text-base focus:outline-none" />
        </div>
