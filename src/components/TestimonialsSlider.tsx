...
const TestimonialsSlider: React.FC = () => {
  ...
  return (
    <section className="w-full px-4 py-12 mt-16 bg-white">
      <div className="max-w-7xl mx-auto">
  <h2 className="text-center text-[24px] md:text-[30px] font-semibold text-[#1F2937] mb-12">What Our Customer&apos;s Says About Us</h2>
  <div className="relative pb-16">
          ...
          <div className="overflow-hidden">
            ...
            >
              {testimonials.map(t => (
                ...
                >
                  <div className="bg-white rounded-2xl p-8 h-full shadow-sm border border-gray-200 flex flex-col justify-between">
                    <div>
                      <div className="flex items-center gap-1 text-amber-400 mb-4" aria-label="5 stars">
                      ...
                      <p className="text-[15px] text-gray-700 leading-7 mb-6">{t.text}</p>
                    </div>
          ...
          <button
            aria-label="Previous"
            onClick={prev}
            className="absolute left-0 bottom-2 w-11 h-11 rounded-full bg-[#222] text-white flex items-center justify-center shadow hover:bg-black transition"
          >
          ...
          <button
            aria-label="Next"
            onClick={next}
            className="absolute right-0 bottom-2 w-11 h-11 rounded-full bg-[#222] text-white flex items-center justify-center shadow hover:bg-black transition"
          >
            <span className="text-base md:text-lg leading-none">→</span>
          </button>
        </div>
