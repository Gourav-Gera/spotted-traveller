...
export default function CityExplorer() {
  ...
  // quick map to real slugs for cities we actually have dedicated pages for
  const nameToSlug: Record<string, string> = { Rome: "rome", Genoa: "genoa" };

  // map tag labels to icons located in public/images
  ...
  return (
    <section className="app-container w-full px-4 mt-16">
      ...
      <p className="text-center text-[16px] text-desc max-w-2xl mx-auto mb-8 leading-relaxed">
			...
			className="flex flex-wrap justify-center gap-3 mb-10 text-[14px] font-semibold"
			>
			{cities.map((c) => {
